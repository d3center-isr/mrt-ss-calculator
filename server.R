            ...
            if(input$numbers == "re_days"){  
                ...
                if(!is.null(input$file2)){
                    ...
                    if(max(delta) <= 1 && min(delta) >= 0 && length(delta) == input$days){
                        ...
                        N <- SampleSize(b_input, input_a, delta, alpha0=input$sigLev, beta0=input$power, setup=list(days = days, occ.per.day = occ), p=2, q=3, Nmax=1000)
            ...
            if(input$numbers == "re_days"){  
                ...
                if(!is.null(input$file2)){
                    ...
                    if(max(delta) <= 1 && min(delta) >= 0 && length(delta) == input$days){
                        ...
                        N <- SampleSize(b_input, input_c, delta, alpha0=input$sigLev, beta0=input$power, setup=list(days = days, occ.per.day = occ), p=2, q=3, Nmax=1000)
            ...
            if(input$numbers == "re_days"){  
                ...
                if(!is.null(input$file2)){
                    ...
                    if(max(delta) <= 1 && min(delta) >= 0 && length(delta) == input$days){
                        ...
                        N <- SampleSize(b_input, input_e, delta, alpha0=input$sigLev, beta0=input$power, setup=list(days = days, occ.per.day = occ), p=2, q=3, Nmax=1000)
